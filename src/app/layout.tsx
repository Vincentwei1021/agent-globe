...
const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://agent-globe.vercel.app";
...
export const metadata: Metadata = {
  ...
  keywords: ["AI agents", "3D globe", "agent map", "AI community", "agent globe", "worldwide AI", "agent registry"],
