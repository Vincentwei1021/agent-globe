      ...
      <main className="px-4 py-12 sm:px-6 sm:py-16">
        <article className="mx-auto max-w-3xl">
          ...
          <div className="mt-8 space-y-6 text-gray-300 leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-white">Why AI Agent Directories Matter</h2>
            <p>
              A well-functioning AI agent directory solves three problems that become acute at scale:
            </p>
            <p>
              <strong className="text-white">Discovery:</strong> How do you find an agent suited to your needs? The current answer is mostly word of mouth, Twitter recommendations, and occasional press coverage. A directory lets you search, filter by category, compare descriptions, and find agents you&apos;d never have stumbled across otherwise.
            </p>
            <p>
              <strong className="text-white">Transparency:</strong> Who built this agent? Where does it operate? What are its capabilities and limitations? Directories create a standard format for this information, making it easier to evaluate agents before you use them.
            </p>
            <p>
              <strong className="text-white">Geography:</strong> AI agent deployment is global, but the visibility is concentrated in English-language tech media. An AI agent directory that captures geographic data — where agents operate, where their developers are based — reveals the full international scope of the ecosystem. Projects like <Link href="/" className="text-cyan-400 hover:underline">Agent Globe</Link> make this geographic dimension literal, mapping agents as points of light on a 3D globe.
            </p>

            <h2 className="text-2xl font-bold text-white">The Types of AI Agent Registries Emerging</h2>
            <p>
              The AI agent directory landscape in 2026 is fragmented, with different approaches serving different needs:
            </p>
            <p>
              <strong className="text-white">Curated directories:</strong> Human-reviewed lists of notable agents, typically organized by category. High quality, but can&apos;t scale to cover the long tail of specialized agents. Think Product Hunt for AI agents.
            </p>
            <p>
              <strong className="text-white">Protocol-level registries:</strong> Several AI agent frameworks (including some built on MCP — the Model Context Protocol) include built-in agent discovery mechanisms. Agents announce their capabilities to a registry; other agents or systems query that registry to find collaborators. These are infrastructure-level directories, not human-facing.
            </p>
            <p>
              <strong className="text-white">Community-built maps:</strong> Open, self-reporting registries where anyone can add their agent. The data quality varies, but the coverage is broad and the discovery is community-driven. Agent Globe falls in this category — a visual, geographic take on the community registry concept.
            </p>
            <p>
              <strong className="text-white">Platform-specific indexes:</strong> Major platforms (GitHub, Hugging Face, various enterprise AI platforms) have their own agent discovery within their ecosystems. Powerful within the platform, but siloed from agents built elsewhere.
            </p>

            <h2 className="text-2xl font-bold text-white">What Makes a Good AI Agent Directory</h2>
            <p>
            ...
            <p>
              <strong className="text-white">Standardized metadata:</strong> The most useful directories have consistent fields for each agent — name, type, capabilities, limitations, developer, deployment context. Inconsistent metadata makes comparison hard.
            </p>
            <p>
              <strong className="text-white">Easy registration:</strong> Directories that require lengthy forms, human approval, or paid tiers have systematically worse coverage than those that allow quick self-registration. The friction-discoverability tradeoff strongly favors low friction.
            </p>
            <p>
              <strong className="text-white">Multiple discovery modes:</strong> Search by keyword, browse by category, filter by geography, sort by recency — different users have different discovery workflows. The best directories support all of them.
            </p>
            <p>
              <strong className="text-white">Geographic data:</strong> Knowing where an agent operates or was developed is increasingly relevant for compliance (data residency), partnership (time zone alignment), and research (understanding the global distribution of AI capability). Directories that capture and display geography — especially visually — provide insight that text-only listings can&apos;t match.
            </p>

            <h2 className="text-2xl font-bold text-white">The Geographic Dimension of AI Agent Deployment</h2>
            <p>
            ...
            <p>
              An AI agent directory that captures this geographic breadth tells a fundamentally different story than one that only logs Silicon Valley startups. <Link href="/" className="text-cyan-400 hover:underline">Agent Globe</Link> was built specifically to make this geographic diversity visible — each registered agent lights up its home location on the 3D globe, turning abstract statistics about global AI growth into something tangible and beautiful.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong className="text-white">Standardization efforts:</strong> Industry groups will attempt to standardize agent metadata schemas, making cross-directory compatibility possible.</li>
              <li><strong className="text-white">Agent-to-agent discovery:</strong> As multi-agent systems become more common, agents will need to find and evaluate other agents autonomously. Protocol-level registries will become critical infrastructure.</li>
              <li><strong className="text-white">Reputation and verification:</strong> Simply listing that an agent exists is insufficient for high-stakes applications. Directory entries will increasingly include performance data, user reviews, and third-party verification of claimed capabilities.</li>
              <li><strong className="text-white">Regulatory requirements:</strong> Several jurisdictions are developing requirements for AI system registration and disclosure. Directories that already capture relevant metadata will be well-positioned to serve as compliance infrastructure.</li>
            </ul>
            <p>
            ...
            <div className="rounded-lg border border-cyan-500/20 bg-cyan-500/5 p-5">
              <p className="font-semibold text-cyan-300">Register your AI agent on the globe</p>
