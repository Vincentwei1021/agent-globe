    ...
    <>
      ...
      <main className="px-4 py-12 sm:px-6 sm:py-16">
        <article className="mx-auto max-w-3xl">
          ...
          <time className="text-sm text-gray-500">March 16, 2026</time>
          ...
          <div className="mt-8 space-y-6 text-gray-300 leading-relaxed">
            ...
            <p>
              <Link href="/" className="text-cyan-400 hover:underline">Agent Globe</Link> is an interactive 3D world map where anyone can register their AI agent and watch it appear as a glowing point of light on the globe. The result is a real-time, community-built visualization of where AI agents are operating around the world.
            </p>

            <h2 className="text-2xl font-bold text-white">Why Map AI Agents?</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold text-white">How Agent Globe Works</h2>
            <p>
              The mechanics are simple. When you <Link href="/#register" className="text-cyan-400 hover:underline">register an agent</Link>, you provide:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li><strong className="text-white">Agent name:</strong> What your agent is called</li>
              <li><strong className="text-white">Agent type:</strong> The category — assistant, coding, research, automation, creative, etc.</li>
              <li><strong className="text-white">Location:</strong> City and country where the agent operates (or where its developers are based)</li>
              <li><strong className="text-white">Description:</strong> A short summary of what the agent does</li>
            </ul>
            <p>
            ...
            <h2 className="text-2xl font-bold text-white">What the Map Reveals</h2>
            <p>
              Even with a relatively small dataset, the map already reveals interesting patterns:
            </p>
            <p>
              <strong className="text-white">Geographic concentration:</strong> The brightest clusters appear in North America&apos;s tech corridor, Western Europe, and East Asia&apos;s major cities. This mirrors broader technology adoption patterns but with some surprises — strong agent activity in unexpected cities suggests more distributed innovation than conventional narratives suggest.
            </p>
            <p>
              <strong className="text-white">Agent type diversity:</strong> Coding agents and assistants dominate in number, but research agents, creative agents, and automation agents are all well-represented. The diversity of agent types signals that AI agents are moving beyond simple chatbots into specialized, domain-specific roles.
            </p>
            <p>
              <strong className="text-white">Emerging markets:</strong> Agent registrations from Southeast Asia, Latin America, and Africa are growing — slowly for now, but the trajectory is clear. AI agent deployment is genuinely global, not just a Silicon Valley phenomenon.
            </p>

            <h2 className="text-2xl font-bold text-white">The Value of a Community-Built Registry</h2>
            <p>
            ...
            <p>
              If you&apos;re building or running an AI agent — whether it&apos;s a personal productivity assistant, a customer service bot, a coding helper, or a research tool — <Link href="/#register" className="text-cyan-400 hover:underline">register it on Agent Globe</Link>. You&apos;ll add one more light to the map and help paint a more complete picture of where AI agency is emerging worldwide.
            </p>

            <h2 className="text-2xl font-bold text-white">The Bigger Picture</h2>
            <p>
            ...
            <div className="rounded-lg border border-cyan-500/20 bg-cyan-500/5 p-5">
              <p className="font-semibold text-cyan-300">Add your agent to the map</p>
